...
<nav>
        ...
        <Link className={styles.linkStyles}  to="/skills">Skills</Link>
        <Link className={styles.linkStyles}  to="/about">About</Link>
        <Link className={styles.linkStyles}  to="/Contact">Contact</Link>
